 ...
 */
class getTacheRealiseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TacheRealiseRepository' shared autowired service.
     *
     * @return \App\Repository\TacheRealiseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TacheRealiseRepository.php';

        return $container->privates['App\\Repository\\TacheRealiseRepository'] = new \App\Repository\TacheRealiseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
