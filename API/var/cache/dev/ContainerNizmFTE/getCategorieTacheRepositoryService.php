 ...
 */
class getCategorieTacheRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieTacheRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieTacheRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieTacheRepository.php';

        return $container->privates['App\\Repository\\CategorieTacheRepository'] = new \App\Repository\CategorieTacheRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
